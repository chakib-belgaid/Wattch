...
mod tests {
    ...
    #[test]
    fn validate_interval_accepts_10ms() {
        validate_interval_ns(10_000_000).expect("10 ms should be accepted");
    }

    #[test]
    fn validate_interval_rejects_below_10ms() {
        let error = validate_interval_ns(9_999_999).expect_err("below 10 ms should fail");
